               ...
               <div class="filter_form">
                  <form method="get">
                     <div class="form-group">
                        ...
                        From <input type="date" name="from" value="<?php echo $from ?>" max="<?php echo date('Y-m-d') ?>" onchange="set_to_date()" id="from_date" class="form-control w250 category-padding">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                                 <button onclick="location.href='expense.php'" class="btn btn-lg btn-info my-submit-button w-100">Reset</button>
                           </div>
                        </div>
                     </div>
                  </form>
